export const skills = {
  ...
  /* ================= XR / HCI ================= */
  "Virtual Reality":   { color: "#7C3AED", category: "xr" },
  "Augmented Reality": { color: "#8B5CF6", category: "xr" },
  "Mixed Reality":     { color: "#A855F7", category: "xr" },
  ...
  "AI Systems":        { color: "#4F46E5", category: "ai" },
  ...
  /* ================= Languages ================= */
  Korean:              { color: "#EF4444", category: "language-skill" },
